...
class Picker {
    ...
    prepareId(splat: Splat, mode: 'add' | 'remove' | 'set' | 'intersect') {
        ...
        this.scene.unifiedRenderTest.beginLegacyPick(splat);
        ...
        this.scene.unifiedRenderTest.endLegacyPick();
    ...
    prepareDepth(splat: Splat) {
        ...
        scene.unifiedRenderTest.beginLegacyPick(splat);
        ...
        this.renderPass.render();
        scene.unifiedRenderTest.endLegacyPick();
