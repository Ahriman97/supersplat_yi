...
class Splat extends Element {
    // Exact PLY snapshot produced by Duplicate/Separate. The autosave journal
    // streams it once and then releases it.
    journalPayload?: Uint8Array;
    asset: Asset;
    ...
    onPreRender() {
        ...
        const transparentLocked = events.invoke('view.transparentLocked');
        ...
        material.setParameter('transparentLocked', transparentLocked ? 1 : 0);
