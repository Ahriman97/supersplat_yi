...
import isolatedSvg from './svg/select-isolated.svg';
...
class BottomToolbar extends Container {
    constructor(events: Events, tooltips: Tooltips, args = {}) {
        ...
        const isolated = new Button({
            id: 'bottom-toolbar-isolated',
            class: 'bottom-toolbar-button',
            enabled: false
        });
        ...
        isolated.dom.addEventListener('click', () => events.fire('select.isolated'));
        ...
        events.on('splat.stateChanged', () => {
            ...
            isolated.enabled = !!selection && selection.numSelected > 0;
        });
        ...
        tooltips.register(isolated, tooltip('tooltip.bottom-toolbar.select-isolated'));
    }
}
